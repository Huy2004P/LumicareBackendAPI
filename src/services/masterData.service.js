...
class MasterDataService {
  ...
  async getRoomById(id) { return await repo.getRoomById(id); } // BỔ SUNG
  ...
  async getServiceById(id) { return await repo.getServiceById(id); } // BỔ SUNG
  ...
  async getAllCodeById(id) { return await repo.getAllCodeById(id); } // BỔ SUNG
